    ...
    <div class="row align-items-center">
      <div class="col-12 col-md-4 text-center">
        <div class="image-container">
          <img src="./assets/img/bg5.jpg" alt="Profile Image" class="img-fluid rounded-circle shadow">
        </div>
      </div>
      <div class="col-12 col-md-8">
        <h2 class="fw-bold display-4 text-light">Nama Lengkap</h2>
        <h4 class="text-warning display-5">Jabatan</h4>
        <p class="text-white-50"> deskripsi lengkap tentang jabatan personil Quos enim maxime nulla itaque blanditiis perspiciatis harum doloremque, porro facilis nostrum dolorem impedit dicta dolore deleniti nobis.</p>
      </div>
    </div>
  </div>
...
<div class="col-12">
        <div class="row">
            <div class="col-12 col-md-6 p-4" style="background-color: #E1D7B7;">
                <div class="display-4 fw-bold ml-4 mb-4">
                    KONTAK
                </div>
                <div class="d-flex align-items-center mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="27px" height="27px" fill="currentColor" class="bi bi-telephone-fill mr-2" viewBox="0 0 16 16">
                      <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.68.68 0 0 0 .178.643l2.457 2.457a.68.68 0 0 0 .644.178l2.189-.547a1.75 1.75 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.6 18.6 0 0 1-7.01-4.42 18.6 18.6 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877z"/>
                    </svg>
                    <div class="d-flex align-items-center">
                        <h4 class="mb-0">No telp :  </h4>
                        <h5 class="ml-3 mt-2">0812334</h5>
                      </div>  
                    </div>             
            </div>
            <div class="col-12 col-md-6 p-4" style="background-color: #EAE4DD;">
                <div class="display-4 fw-bold ml-4 mb-4">
                        ALAMAT
                </div>
                <div class="d-flex align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="27px" height="27px" fill="currentColor" class="bi bi-geo-alt-fill mr-2" viewBox="0 0 16 16">
                        <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6"/>
                      </svg>
                      <div class="d-flex align-items-center">
                        <h4 class="mb-0">Alamat Lengkap :  </h4>
                        <h5 class="ml-3 mt-2">ngawi</h5>
                      </div>  
                    </div>            
            </div>
    </div>
