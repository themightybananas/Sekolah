...
<head>
    ...
    <section>
        <div class="p-0 overflow-hidden container-fluid">
            <div class="row g-0 bg-light">
                <div class="col-lg-6 order-lg-2" style="min-height: 45vh; background-size: cover; background-position: center; background-image: url('./assets/img/fasilitas/Perpus.jpg');">
                </div>
                <div class="col-lg-6 order-lg-1 my-auto px-5 py-5">
                    <div class="lc-block">
                        <div editable="rich">
                            <h1>Peminjaman Buku</h1>
                            <p class="lead text-justify">Selamat datang di perpustakaan sekolah kami, Kami menyediakan layanan peminjaman buku untuk para siswa, guru, dan staf sekolah. Dengan koleksi buku yang beragam, mulai dari buku pelajaran, ensiklopedia, novel, hingga literatur umum, perpustakaan kami adalah tempat yang tepat untuk meningkatkan wawasan dan mendukung proses belajar-mengajar.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row g-0 bg-dark">
                <div class="col-lg-6" style="min-height: 45vh; background-size: cover; background-position: center; background-image: url('./assets/img/fasilitas/Uks.jpg');">
                </div>
                <div class="col-lg-6 my-auto px-5 py-5 text-white">
                    <div class="lc-block">
                        <div editable="rich">
                            <h1>UKS</h1>
                            <p class="lead text-white text-justify">Unit Kesehatan Sekolah (UKS) merupakan salah satu program penting di sekolah yang bertujuan untuk meningkatkan kesehatan siswa, guru, dan seluruh warga sekolah. UKS tidak hanya menyediakan layanan kesehatan dasar, tetapi juga berfungsi sebagai sarana edukasi kesehatan, pencegahan penyakit, dan promosi hidup sehat di lingkungan sekolah.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row g-0 bg-light">
              <div class="col-lg-6 order-lg-2" style="min-height: 45vh; background-size: cover; background-position: center; background-image: url('./assets/img/fasilitas/Lab-Kecil-2.jpg');">
              </div>
              <div class="col-lg-6 order-lg-1 my-auto px-5 py-5">
                  <div class="lc-block">
                      <div editable="rich">
                          <h1>Peminjaman Laptop</h1>
                          <p class="lead text-justify">Peminjaman Laptop secara gratis adalah inisiatif yang bertujuan untuk mendukung kesuksesan akademik siswa dengan menyediakan perangkat teknologi yang memadai. Dalam program ini, sekolah memfasilitasi peminjaman laptop kepada murid yang memerlukan perangkat untuk keperluan belajar, terutama untuk menyelesaikan tugas-tugas sekolah, mengikuti pembelajaran digital, dan mengembangkan keterampilan teknologi.</p>
                      </div>
                  </div>
              </div>
          </div>
  ...
  <!-- CAROUSEL -->
  <section class="pb-5 p-1 bg-dark">
